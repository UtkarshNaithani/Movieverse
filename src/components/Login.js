    ...
    return (
        <div className='w-full flex flex-col mt-12 items-center '>
            ...
            <div class="p-2 w-full mt-3">
                <button onClick={login} class="flex mx-auto text-white bg-green-600 border-0 py-2 px-8 focus:outline-none hover:bg-green-800 rounded text-lg">{loading ? <TailSpin height={25} color='white' /> : 'Login'}</button>
            </div>
            <div className='mt-3'>
