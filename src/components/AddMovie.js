...
const AddMovie = () => {
  ...
  //Inititally form value i.e. title,year,description=null
  ...
  //add data inside our collection
  const addmovie= async() => {
    setLoading(true);
    try{
      //if user logged in then only he can add the movie
      if(useAppstate.login){
    //will add moviesinfo that user types to collection
  ...
  //After submitting your data,it will again go blank
  setform({
    title: "",
    year:"",
    description:"",
            ...
            <div class="flex flex-wrap -m-2">
              <div class="p-2 w-1/2">
                <div class="relative">
                  ...
                  {/* value is form object's value, onchange an event will occur, ...-spread operator allows to copy the value into an existing array */}
